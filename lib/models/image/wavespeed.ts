...
export type WaveSpeedImageModelId =
  ...
  | 'google/nano-banana-pro/multi'
  | 'google/nano-banana-pro/ultra'
...
export const wavespeedImage = {
  ...
  // NANO BANANA (Google) - Text to Image
  // ========================================
  nanoBanana: () => createTextToImageModel('google/nano-banana'),
  nanoBananaPro: () => createTextToImageModel('google/nano-banana-pro'),
  nanoBananaProMulti: () => createTextToImageModel('google/nano-banana-pro/multi'),
  nanoBananaProUltra: () => createTextToImageModel('google/nano-banana-pro/ultra'),
